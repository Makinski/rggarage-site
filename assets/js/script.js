...
if (mainGalleryImage && galleryThumbs.length) {
  ...
  if (document.body.classList.contains('page-e92') && thumbs.length >= 2) {
    ...
    const imageVersion = 'v=20260625b';
    const e92Images = [
      {
      ...
      {
        src: `${imagePrefix}assets/images/cars/m3/1428d412801459c4030926c348fc301b.jpg?${imageVersion}`,
        alt: isBulgarian ? 'BMW M3 E92 страничен и преден изглед' : 'BMW M3 E92 side and front view',
      },
    ];
